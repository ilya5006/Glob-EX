    ...
    <div class="profile">
        <div class="first">
            <form action="./model/updateUserInfo.php" method="GET" class="edit">
                ...
                <div class="buttons">
                    <input id="editButton" class="button" type="submit" name="change" value="сохранить">
            ...
            <form action="./model/updateUserAddress.php" method="GET" class="edit">
                ...
                <label class="placeinput additionalAdress" style="display: none;">
                    ...
                    <?php echo '<input type="text" id="fio" name="additional_address1" value="'.$userData['additional_address1'].'" autocomplete="address-line2">'; ?>
                    <div class="place_holder">Введите дополнительный адрес<span>*</span></div>
                </label>
                <label class="placeinput additionalAdress" style="display: none;">
                    <p class="input-info">Доп. адрес:</p>
                    <?php echo '<input type="text" id="fio" name="additional_address2" value="'.$userData['additional_address2'].'" autocomplete="address-line2">'; ?>
                    <div class="place_holder">Введите дополнительный адрес<span>*</span></div>
                </label>
                <label class="placeinput additionalAdress" style="display: none;">
                    <p class="input-info">Доп. адрес:</p>
                    <?php echo '<input type="text" id="fio" name="additional_address3" value="'.$userData['additional_address3'].'" autocomplete="address-line2">'; ?>
                    <div class="place_holder">Введите дополнительный адрес<span>*</span></div>
                </label>
                <label class="placeinput additionalAdress" style="display: none;">
                    <p class="input-info">Доп. адрес:</p>
                    <?php echo '<input type="text" id="fio" name="additional_address4" value="'.$userData['additional_address4'].'" autocomplete="address-line2">'; ?>
                    <div class="place_holder">Введите дополнительный адрес<span>*</span></div>
                </label>
                <label class="placeinput additionalAdress" style="display: none;">
                    <p class="input-info">Доп. адрес:</p>
                    <?php echo '<input type="text" id="fio" name="additional_address5" value="'.$userData['additional_address5'].'" autocomplete="address-line2">'; ?>
                    <div class="place_holder">Введите дополнительный адрес<span>*</span></div>
                </label>
                <div class="buttons">
                    <div class="button" id="addAddress"> Добавить адресс </div>
